...
\item For efficient data plumbing and state management, used a combination of Relay and Recoil. Relay is used to fetch page data and maintain global state. Advanced Recoil APIs are used to sync some local state with localStorage.
...
\item \textbf{Stack: React, TypeScript, pnpm, Nextjs, Hasura, Supabase, Relay, Recoil, Radix-UI, Tailwind CSS, visx, Splitbee, Cypress, Vercel, WebStorm, Zoho One}
\end{itemize}
